    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.lavasoft.GeoIPService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.lavasoft.GeoIPService.class.getResource(".");
            url = new URL(baseUrl, "http://wsgeoip.lavasoft.com/ipservice.asmx?WSDL");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://wsgeoip.lavasoft.com/ipservice.asmx?WSDL', retrying as a local file");
    ...
    public GeoIPService() {
        super(GEOIPSERVICE_WSDL_LOCATION, new QName("http://lavasoft.com/", "GeoIPService"));
    }
